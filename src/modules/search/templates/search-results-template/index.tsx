...
const SearchResultsTemplate = ({
  ...
  return (
    <>
      <div className="flex sm:pt-32 pt-20 justify-between border-b w-full py-6 px-8 small:px-14 items-center">
      ...
      <div className="flex flex-col p-6">
        {ids.length > 0 ? (
          <>
            ...
            <div className="w-full flex-col  small:items-start  content-container ">
              <RefinementList sortBy={sortBy || "created_at"} search />
              <div className="content-container">
                <PaginatedProducts
                  productsIds={ids}
